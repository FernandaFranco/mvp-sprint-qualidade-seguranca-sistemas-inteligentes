...
url = (
    "https://raw.githubusercontent.com/FernandaFranco/Gaming-Behavior/main/"
...
def test_recall_por_classe():
    ...
    recall_minimo = (recall >= 0.80).all()
    assert recall_minimo, f"Recall por classe {recall} abaixo do mínimo 0.80"
